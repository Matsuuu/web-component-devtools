...
import {
    ...
    QUERY_RESULT,
    SELECTED_ELEMENT,
    SELECTED_ELEMENT_OBSERVER_DISCONNECTERS,
    SELECT_RESULT,
    SPOTLIGHT_ELEMENT,
...
import { listenForMutations } from './mutation-observer.js';
...
export function selectElement(eventData) {
    ...
    if (selectedElement.shadowRoot) {
        addSelectedElementObserverDisconnecter(listenForMutations(selectedElement.shadowRoot, true));
    }
