import { AnalyzeElementMessage, AnalyzeElementResultMessage, MESSAGE_TYPE } from "../types/message-types.js";
...
async function analyzeCustomElement(message, port) {
    ...
    sendMessage(CONNECTION_HOSTS.CONTENT, new AnalyzeElementResultMessage({
        analysisResult: eventData,
    }), port);
}
