import { AnalyzeElementMessage, AnalyzeElementResultMessage, HighlightMessage, MESSAGE_TYPE, QueryMessage, QueryResultMessage, SelectMessage, SelectResultMessage } from '../types/message-types.js';
...
import { CONNECTION_HOSTS, connectToRouter, messageIs, PingMessage, PongMessage, sendMessage, sendMessageAndAwaitResponse } from '../messaging/messaging.js';
...
async function doAnalyze(eventData) {
    ...
    if (navigator.userAgent.includes('Chrome')) {
        ...
        const analysisResponse = await sendMessageAndAwaitResponse(CONNECTION_HOSTS.BACKGROUND, analyzeMessage, AnalyzeElementResultMessage);
