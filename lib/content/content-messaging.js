...
function onNydusBuild(nydus) {
    ...
    nydus.addConnection(CONNECTION_TYPES.DEVTOOLS_BACKGROUND_CONTENT_INIT, true);
}
...
function onNydusReady(nydus) {
    console.log("Communication with Background initialized", nydus);
    nydus.message(CONNECTION_TYPES.DEVTOOLS_BACKGROUND_CONTENT_INIT, "Hello");
}
