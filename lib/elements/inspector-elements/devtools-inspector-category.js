...
import { MESSAGE_TYPE, SelectMessage, TriggerEventMessage, UpdateAttributeMessage, UpdatePropertyMessage } from '../../types/message-types.js';
...
export class DevToolsInspectorCategory extends LitElement {
    ...
    updateAttributeOrPropertyValue(eventData) {
        ...
        if (this.categoryType === "attributes") {
            sendMessage(CONNECTION_HOSTS.CONTENT, new UpdateAttributeMessage({
            ...
            sendMessage(CONNECTION_HOSTS.CONTENT, new UpdatePropertyMessage({
                index: this.selectedElement.indexInDevTools,
                value: eventData.value,
                elementType,
                attributeOrProperty: eventData.property,
