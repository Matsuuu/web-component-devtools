...
import { DevToolsInspector } from './devtools-inspector.js';
...
class DevToolsElementList extends LitElement {
    ...
    firstUpdated() {
        this.customElementsInspector = this.parentNode.querySelector('devtools-inspector');
    }
