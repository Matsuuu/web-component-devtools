...
import { HighlightMessage, MESSAGE_TYPE, RefreshMessage, ScrollIntoViewMessage } from '../../types/message-types.js';
...
export class DevToolsElementList extends LitElement {
    ...
    _initSubChannel() {
        document.addEventListener(new RefreshMessage().type, this.reload.bind(this));
    }
