    ...
    render() {
        return html`
            <details @toggle=${this._onToggle}>
                <summary>
                    <span>
                        ${this.property.static
                ? html`<devtools-static-indicator dir="right"></devtools-static-indicator>`
                : ''}
                        <label>${this.propName}:</label><label class="preview">${this._getObjectPreview()}</label></span
                    >
                </summary>
