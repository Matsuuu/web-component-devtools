...
import './devtools-inheritance-indicator.js';
...
export class DevToolsEventItem extends LitElement {
    ...
    render() {
        ...
        ${this.event.inheritedFrom ? html`<devtools-inheritance-indicator parentClass=${this.event.inheritedFrom.name}></devtools-inheritance-indicator>` : ''} `;
    }
